...
uint256 hashGenesisBlock("0xe1f69c24bf2603542f350f6b01447a6a8f0cebd06ae0829ddbfe52ae748094c3");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // Corncoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Corncoin Signed Message:\n";
...
{
    // Corncoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Corncoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // Corncoin: 3.5 days
static const int64 nTargetSpacing = 120; // Corncoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Corncoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Corncoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Corncoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x75e98299aec4d4977cc887b1997d84c7cfffafd42ad5f8a967db0514569d8809");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Id just like to interject for a moment";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 10000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("e7a7baf698a17171254aa5d6493b12a32ea605c697e97ef8c1e655a953cc8c00c7e8678b0c4e91afd241afb0d23af5252158af5fe67c3b5c65e365e8c5808fcae3") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1517965181;
        block.nBits    = 504365644;
        block.nNonce   = 826746511;

        if (fTestNet)
        {
            block.nTime    = 1517965181;
            block.nNonce   = 1398920247;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x4e2309a2c6b9fc3b6a89ba42023bc41923718220f74b847a322a4e6a53520a29"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Corncoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("CorncoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("CorncoinMiner : ProcessBlock, block not accepted");
    }
